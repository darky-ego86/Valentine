...
function checkPassword() {
    console.log('checkPassword called'); // Debug log
    ...
    console.log('Entered password:', input.value); // Debug log
    console.log('Expected password:', CONFIG.password); // Debug log
    
    if (input.value === CONFIG.password) {
        console.log('Password correct! Unlocking...'); // Debug log
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    createFloatingHearts(); // Start hearts animation immediately
    ...
    if (passwordInput) {
        ...
        console.error('Password input NOT found'); // Debug log
    }
});
...
`;
document.head.appendChild(style);    const volumeSlider = document.getElementById('volumeSlider');
    const musicUpload = document.getElementById('musicUpload');
